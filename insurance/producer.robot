...
# Why not having these as global variables/constants already? (or maybe we wanted to
#  limit their visibility and scope inside of the keyword only)
${max_rate}        ${5.0}
...
Download traffic data
    ...
    ...    overwrite=${True}  # we might want it like this (instead of string "True")
...
Filter and sort traffic data
    ...
    # [Return]    ${table}  # isn't required to return as the received table is mutable
...
Save work item payload
    ...
    Create Output Work Item    variables=${variables}    save=${True}  # ditto
...
Produce traffic data work items
    ...
    Filter and sort traffic data    ${traffic_data}
